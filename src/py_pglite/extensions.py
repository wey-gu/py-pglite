...
SUPPORTED_EXTENSIONS: dict[str, dict[str, str]] = {
    ...
    "btree_gin": {"module": "@electric-sql/pglite/contrib/btree_gin", "name": "btree_gin"},
    "btree_gist": {"module": "@electric-sql/pglite/contrib/btree_gist", "name": "btree_gist"},
    "fuzzystrmatch": {"module": "@electric-sql/pglite/contrib/fuzzystrmatch", "name": "fuzzystrmatch"},
}
